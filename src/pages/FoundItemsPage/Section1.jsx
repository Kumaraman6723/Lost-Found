  ...
  const handleClaim = async (item) => {
    if (user) {
      ...
      try {
        ...
        toast.success(
          "Item claimed successfully! You can collect your item from the security room."
        );
      } catch (error) {
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-2">Found Inventory</h1>
        <h6 className="text-lg text-gray-600">List of items that are found</h6>
